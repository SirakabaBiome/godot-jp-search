            ...
            grmr_kotlin: e => {
                ...
                const n = e.regex, t = /[\p{XID_Start}_]\p{XID_Continue}*/u,
                    ...
                    i = {
                        ...
                        type: ["Any", "Coroutine", "Dict", "List", "Literal", "Generic", "Optional", "Sequence", "Set", "Tuple", "Type", "Union"]
...
document.addEventListener("DOMContentLoaded", ev => {
    ...
    // ブロックじゃないcodeもキーワード光らせたい
    const codeTags = document.querySelectorAll('code:not(.hljs)');
    codeTags.forEach(code => {
        code.setAttribute('data-language', 'gdscript');
        // if (localStorage.getItem("pref-theme")==="light"){
        //     code.classList.add("light")
        // }else{
        //     code.classList.add("dark")
        // }
